...
export default async function ReservationDetailPage({ params }: { params: Promise<{ id: string }> }) {
	...
	const canCancel =
		...
		new Date(reservation.date) > new Date(Date.now() + 48 * 60 * 60 * 1000);
	...
	const paymentBadgeVariant: Record<string, "yellow" | "green" | "red" | "blue" | "gray"> = {
		yellow: "yellow",
		green: "green",
		red: "red",
		blue: "blue",
				...
				<div className="flex flex-col gap-4">
						...
						<div className="bg-[#141414] border border-[#222] rounded-xl p-6">
							...
							<div className="space-y-3">
								...
								<div className="flex justify-between text-sm">
									...
									<Badge variant={paymentBadgeVariant[paymentStatusInfo.color]}>
								...
								{reservation.payment.failureReason && (
									<div className="pt-2 border-t border-[#222]">
										<p className="text-xs text-[#5A5249] mb-1">Motif</p>
					...
					{reservation.invoice && (
						<div className="bg-[#141414] border border-[#222] rounded-xl p-6">
							...
							<p className="text-sm text-[#9A8F84] mb-3">
								N° {reservation.invoice.invoiceNumber}
							</p>
					...
					{canRetryPayment && <RetryPaymentButton reservationId={reservation.id} />}
