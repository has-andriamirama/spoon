...
export async function POST(request: Request) {
  try {
    ...
    await createAdminNotification({ type: "event_request", title: "Nouvelle demande d'événement", message: `${event.firstName} ${event.lastName} — ${event.eventType}`, link: `/admin/events` });
